...
#define tamanioMaxPaquete 35
#define tamanioMinPaquete 7



//CANT MAX DE MUESTRAS:
#define tamanoArreglo 50
...
void requestEvent() {
  ...
  switch (i) {
    case 0:
      {
        Serial.println((char)send_buf[0]);
    ...
    case 1:
      {
        ...
        Serial.println((char*)auxiliar);
        Wire.write((char*) auxiliar,6);
        i++;
      } break;
    ...
    case 2:{
      ...
      while (k < 6) {
        ...
        Wire.write((char*) segundoMensaje,6);
      i++;
      }break;
      
    case 3:
      {
        int k = 6; //posicion donde me quede leyendo del buffer 7
        
        //voy a pasar el resto del mensaje a OTRO buffer para enviar al master
        while (k < tamanoTipo && send_buf[k] != '>') {

          segundoMensaje[k - 6] = send_buf[k];
          k++;
        }
        segundoMensaje[k - 6] = send_buf[k];
